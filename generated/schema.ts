...
export class ExecutionsCancelled extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ExecutionsCancelled entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ExecutionsCancelled must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ExecutionsCancelled", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ExecutionsCancelled | null {
    return changetype<ExecutionsCancelled | null>(
      store.get_in_block("ExecutionsCancelled", id.toHexString())
    );
  }

  static load(id: Bytes): ExecutionsCancelled | null {
    return changetype<ExecutionsCancelled | null>(
      store.get("ExecutionsCancelled", id.toHexString())
    );
  }
...
export class AutoSaveExecuted extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save AutoSaveExecuted entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type AutoSaveExecuted must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("AutoSaveExecuted", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): AutoSaveExecuted | null {
    return changetype<AutoSaveExecuted | null>(
      store.get_in_block("AutoSaveExecuted", id.toHexString())
    );
  }

  static load(id: Bytes): AutoSaveExecuted | null {
    return changetype<AutoSaveExecuted | null>(
      store.get("AutoSaveExecuted", id.toHexString())
    );
  }
...
export class ModuleInstalled extends Entity {
  ...
  get moduleTypeId(): BigInt {
    let value = this.get("moduleTypeId");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set moduleTypeId(value: BigInt) {
    this.set("moduleTypeId", Value.fromBigInt(value));
  }
...
export class ModuleQuery extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ModuleQuery entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ModuleQuery must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ModuleQuery", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ModuleQuery | null {
    return changetype<ModuleQuery | null>(
      store.get_in_block("ModuleQuery", id.toHexString())
    );
  }

  static load(id: Bytes): ModuleQuery | null {
    return changetype<ModuleQuery | null>(
      store.get("ModuleQuery", id.toHexString())
    );
  }
  ...
  get isInstalled(): boolean {
    let value = this.get("isInstalled");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set isInstalled(value: boolean) {
    this.set("isInstalled", Value.fromBoolean(value));
  }
}

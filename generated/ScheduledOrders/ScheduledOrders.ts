...
export class ScheduledOrders extends ethereum.SmartContract {
  ...
  getAccountJobDetails(
    ...
    jobId: BigInt
  ): ScheduledOrders__getAccountJobDetailsResultValue0Struct {
    ...
    return changetype<ScheduledOrders__getAccountJobDetailsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      changetype<ScheduledOrders__getAccountJobDetailsResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
